...
class EGLPlayerActivity: AppCompatActivity() {
    private val path = Environment.getExternalStorageDirectory().absolutePath + "/testziliao/biterate9.mp4"
    private val path2 = Environment.getExternalStorageDirectory().absolutePath + "/testziliao/v1080.mp4"
