...
class MultiOpenGLPlayerActivity: AppCompatActivity() {
    private val path = Environment.getExternalStorageDirectory().absolutePath + "/v1080.mp4"
    private val path2 = Environment.getExternalStorageDirectory().absolutePath + "/testziliao/biterate9.mp4"
