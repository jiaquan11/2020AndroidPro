...
public class WLYuvRender implements WLEGLSurfaceView.WLGLRender {
    ...
    public void onSurfaceCreated() {
        ...
        String vertexShader = WLShaderUtil.readRawTxt(context, R.raw.vertex_shader_yuv);
        String fragmentShader = WLShaderUtil.readRawTxt(context, R.raw.fragment_shader_yuv);
        ...
        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_RGBA, 1080, 500, 0, GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE, null);
        GLES20.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, GLES20.GL_COLOR_ATTACHMENT0, GLES20.GL_TEXTURE_2D, textureid, 0);
        if (GLES20.glCheckFramebufferStatus(GLES20.GL_FRAMEBUFFER) != GLES20.GL_FRAMEBUFFER_COMPLETE) {
            Log.e("WLYuvRender", "fbo wrong");
        } else {
            Log.e("WLYuvRender", "fbo success");
        }
